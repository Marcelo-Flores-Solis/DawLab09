// Departamentos del Perú y sus provincias (25 departamentos / 196 provincias).
// Debe mantenerse idéntico a la copia del backend en `ecomerce/peru_geo.py`,
// que valida que sólo se guarden ubicaciones reales.
export const PERU: Record<string, string[]> = {
