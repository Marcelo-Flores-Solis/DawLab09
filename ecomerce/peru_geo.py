# Departamentos del Perú y sus provincias (fuente: demarcación oficial, 25
# departamentos / 196 provincias). Se usa para validar direcciones: sólo se
# aceptan combinaciones que existen de verdad. Mantener idéntico a la copia del
# frontend en `frontend/src/data/peru.ts`.
